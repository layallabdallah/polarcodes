...
Rate = K/N;
n = log2(N);
p = 0.05; % the probability of occurrence of a noise pulse

for EbNodB = 2.5:0.5:3
    ...
    %simulate
    Nbiterrs = 0; Nblkerrs = 0;Nblocks = 2000*floor(exp(EbNo^2/2));
   ...
   %add noise
    ...
    r = r.*(rand(1,N)>p); %r(i)=0 in presence of impulsive noise
